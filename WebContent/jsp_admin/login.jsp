...
<body
	...
	/*  background-image: url(http://admin.cxso.cn/manage/images/light.png);  */ background-repeat: no-repeat; background-position: center top; overflow: hidden;"
	onload="init();">
	<form name="form1" method="post" action=""
		...
		<div class="loginbody">
			...
			<div class="loginbox">
				<ul>
					<li><input name="username" type="text" id="username"
						class="loginuser" /></li>
					<li><input name="password" type="password" id="password"
						class="loginpwd" /></li>
		...
		<div class="loginbm">上海信而富&nbsp;&nbsp;&nbsp;&nbsp;版权所有 2015</div>
	</form>
</body>
</html>
