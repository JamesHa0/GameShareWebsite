...
<tyTag:page tarFrame="frame1" method="withdrawController.do?method=queryWithdrawListTable" pageTurn="<%=PageUtil.TURN_YES %>"></tyTag:page>
<tyTag:actorBtnTag value="${btn_ids }"/>
</form>
</body>
    <script type="text/javascript">
    	function query(){
    		document.forms[0].action = "withdrawController.do?method=queryWithdrawListTable";
