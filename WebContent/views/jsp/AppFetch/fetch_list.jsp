...
<!-- 		<td width="8%" align="left"><input  type="text"  name="withdrawFuiouLoginId"></td> -->
		...
		<td width="7%" align="right">赎回状态:</td>
		<td width="8%" align="left">
			 <select name="fetchState" >
			 	<option value="" selected="selected">--请选择--</option>
			 	<option value="1">赎回成功</option>
			 	<option value="0">赎回失败</option>
			 </select>
		</td>
		<td width="7%" align="right">姓名:</td>
		<td width="8%" align="left"><input  type="text"  name="fetchName"></td>
	</tr>
	<tr>
		<td width="7%" align="right">赎回时间:</td>
...
<tyTag:page tarFrame="frame1" method="fetch.do?queryFetchListTable" pageTurn="<%=PageUtil.TURN_YES %>"></tyTag:page>
<tyTag:actorBtnTag value="${btn_ids }"/>
</form>
</body>
    <script type="text/javascript">
    	function query(){
    		document.forms[0].action = "fetch.do?queryFetchListTable";
    	...
    	function updateAAA(){
    		...
    		if(confirm("确认提交吗?")){
        		...
        		document.forms[0].action = "fetch.do?updateUploadStatus";
