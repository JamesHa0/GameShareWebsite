...
<body>
	<form name="form0" class="form-inline definewidth m20"
		...
		<tyTag:page tarFrame="frame1"
			method="financialMoneysDaily.do?queryFinancialMoneysDailyListTable"
...
<script type="text/javascript">
	...
	function query() {
		document.forms[0].action = "financialMoneysDaily.do?queryFinancialMoneysDailyListTable";//&keyword="+document.getElementById("ackeyword").value
