...
<body>
	<form name="form0" class="form-inline definewidth m20"
		...
		<tyTag:page tarFrame="frame1"
			method="financialDaily.do?queryFinancialDailyListTable"
...
<script type="text/javascript">
	...
	function query() {
		document.forms[0].action = "financialDaily.do?queryFinancialDailyListTable";//&keyword="+document.getElementById("ackeyword").value
