...
<form name="form0" class="form-inline definewidth m20" 
		action="pc_SystemController.do?getOnlineUserListTable" method="post">
<table width="95%" align="center" border="0">
	<tr>
<!-- 		<td width="6%" align="left">用户名:</td> -->
...
<tyTag:page tarFrame="frame1" method="pc_SystemController.do?getOnlineUserListTable" pageTurn="<%=PageUtil.TURN_NO %>"></tyTag:page>
</form>
</body>
