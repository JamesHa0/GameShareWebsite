...
<tyTag:page tarFrame="frame1" method="fundingController.do?method=queryFundingListTable" pageTurn="<%=PageUtil.TURN_YES %>"></tyTag:page>
<%-- <tyTag:actorBtnTag value="${btn_ids }"/> --%>
</form>
</body>
    <script type="text/javascript">
    	function query(){
    		document.forms[0].action = "fundingController.do?method=queryFundingListTable";
    	...
    	function updateAAA(){
    		...
    		if(confirm("确认提交吗?")){
        		...
        		document.forms[0].action = "fundingController.do?updateUploadStatus";
    	...
    	function updateBBB(){
    		if(confirm("确认导出吗?")){
        		document.forms[0].action = "fundingController.do?exportFundingList";
        		document.forms[0].target="_self";
        		document.forms[0].submit();
    		}
    	}
