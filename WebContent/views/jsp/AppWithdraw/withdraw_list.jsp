...
<tyTag:page tarFrame="frame1" method="appWithdraw.do?queryWithdrawListTable" pageTurn="<%=PageUtil.TURN_YES %>"></tyTag:page>
<tyTag:actorBtnTag value="${btn_ids }"/>
</form>
</body>
    <script type="text/javascript">
    	function query(){
    		document.forms[0].action = "appWithdraw.do?queryWithdrawListTable";
    	...
    	function updateAAA(){
    		...
    		if(confirm("确认提交吗?")){
        		...
        		document.forms[0].action = "appWithdraw.do?updateUploadStatus";
