...
<table  align="center" border="0" class="q-cls">
	<tr>
		...
		<td align="right" style="padding-right: 2%">
			...
			<button type="button" class="btn btn-success" onclick="addBank();">新增银行</button>
		</td>
	</tr>
</table>
<tyTag:page tarFrame="frame1" method="bank.do?queryBankListTable" pageTurn="<%=PageUtil.TURN_YES %>"></tyTag:page>
</form>
</body>
    <script type="text/javascript">
    	function query(){
    		document.forms[0].action = "bank.do?queryBankListTable&keyword="+document.getElementById("ackeyword").value;
    		document.forms[0].target="frame1";
    		document.forms[0].submit();
    	}
    	function addBank(){
    		window.location.href="bank.do?addOrUpdateBank&flag=add";
    	}
    </script>
</html>
