...
<script type="text/javascript">
	function updateUser(username){
		window.parent.location.href="userController.do?method=addOrUpdateUser&flag=update&username="+username;
	}
	function deleteUser(username){
		window.parent.location.href="userController.do?method=deleteUser&username="+username;
	}
    ...
    <c:forEach items="${userList}"  var="user">
     <tr >
           ...
           <td>
               ...
               <a href="javascript:void('0');" onclick="deleteUser('${user.username}');">删除</a> 
