...
<table width="100%" align="center" border="0" class="q-cls">
	<tr>
		...
		<td width="7%" align="right">会话类型:</td>
		<td width="8%" align="left">
			 <select name="recordOpercode" >
			 	<option value="">--请选择--</option>
			 	<option value="1000">创建未接入会话</option>
			 	<option value="1001">接入会话</option>
			 	<option value="1002">主动发起会话</option>
			 	<option value="1003">转接会话</option>
			 	<option value="1004">关闭会话</option>
			 	<option value="1005">抢接会话</option>
			 	<option value="2001">公众号收到消息</option>
			 	<option value="2002">客服发送消息</option>
			 	<option value="2003">客服收到消息</option>
			 </select>
		</td>
	</tr>
	<tr>
...
<tyTag:page tarFrame="frame1" method="wechatController.do?queryRecordListTable" pageTurn="<%=PageUtil.TURN_YES %>"></tyTag:page>
</form>
</body>
    <script type="text/javascript">
    	function query(){
    		document.forms[0].action = "wechatController.do?queryRecordListTable";
